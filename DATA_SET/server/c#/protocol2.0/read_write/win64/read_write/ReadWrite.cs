...
namespace read_write
{
    class ReadWrite
    {
        ...
        // Default setting
        public const int DXL_ID = 4;                   // Dynamixel ID: 1
        ...
        static void Main(string[] args)
        {
          ...
          /*  string currentPath = @"C:\Users\myungseope";
            currentPath += "\\Save";

            string filePath = currentPath + "\\test.txt";

            FileStream forEmpty = new FileStream(
                          filePath,              //저장경로
      ...
      /*              FileStream fileStream = new FileStream(
                    ...
                    float floatdata = (float)dxl_present_position / 100;
